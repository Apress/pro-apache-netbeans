...
public class HyperledgerWizardIterator implements WizardDescriptor./*Progress*/InstantiatingIterator {
    ...
    public HyperledgerWizardIterator() {
    }

    public static HyperledgerWizardIterator createIterator() {
        return new HyperledgerWizardIterator();
    }

    private WizardDescriptor.Panel[] createPanels() {
        return new WizardDescriptor.Panel[]{
            new HyperledgerWizardPanel(),};
    }

    private String[] createSteps() {
        return new String[]{
            NbBundle.getMessage(HyperledgerWizardIterator.class, "LBL_CreateProjectStep")
        };
    }
